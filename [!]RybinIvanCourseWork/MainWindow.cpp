    ...
    ui(new Ui::MainWindow)
{
    ...
    setWindowTitle("Театры Петербурга");
}
...
void MainWindow::on_action_Add_triggered()
{
    ...
    if (addRecordDialogWindow.exec() == QDialog::Accepted)
    {
        ...
        ui->tableWidget->setItem(newRow, 1, new QTableWidgetItem(newRecord.getName()));
        ui->tableWidget->setItem(newRow, 2, new QTableWidgetItem(newRecord.getAdress()));
        ui->tableWidget->setItem(newRow, 3, new QTableWidgetItem(newRecord.getOpeningDate()));
        ui->tableWidget->setItem(newRow, 4, new QTableWidgetItem(newRecord.getArtisticDirection()));
...
void MainWindow::on_action_Edit_triggered()
{
    ...
    if (list.size() > 0) {
        ...
        editRecordDialogWindow.setName(list.at(1)->text());
        editRecordDialogWindow.setAdress(list.at(2)->text());
        editRecordDialogWindow.setOpeningDate(list.at(3)->text());
        editRecordDialogWindow.setArtisticDirection(list.at(4)->text());
        if (editRecordDialogWindow.exec() == QDialog::Accepted)
        {
            Theater editedRecord = editRecordDialogWindow.getData();
            list.at(1)->setText(editedRecord.getName());
            list.at(2)->setText(editedRecord.getAdress());
            list.at(3)->setText(editedRecord.getOpeningDate());
            list.at(4)->setText(editedRecord.getArtisticDirection());
            main_vector[list.at(1)->row()].setName(editedRecord.getName());
            main_vector[list.at(2)->row()].setAdress(editedRecord.getAdress());
            main_vector[list.at(3)->row()].setOpeningDate(editedRecord.getOpeningDate());
            main_vector[list.at(4)->row()].setArtisticDirection(editedRecord.getArtisticDirection());
